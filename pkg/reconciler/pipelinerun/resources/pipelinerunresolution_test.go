...
var retryableFinalStateMatrix = PipelineRunState{{
	PipelineTask: &pts[15],
	TaskRunNames: []string{"pipelinerun-mytask1"},
	TaskRuns:     []*v1beta1.TaskRun{makeSucceeded(trs[0])},
	ResolvedTaskResources: &resources.ResolvedTaskResources{
	...
	TaskRuns:     []*v1beta1.TaskRun{makeFailed(trs[2])},
	ResolvedTaskResources: &resources.ResolvedTaskResources{
		TaskSpec: &task.Spec,
	},
}}
...
var oneRunFinishedStateMatrix = PipelineRunState{{
	PipelineTask: &pts[18],
	CustomTask:   true,
	RunNames:     []string{"pipelinerun-mytask13"},
...
var runCancelledMatrix = PipelineRunState{{
	PipelineTask: &pts[18],
	CustomTask:   true,
	RunNames:     []string{"pipelinerun-mytask13"},
	Runs:         []*v1alpha1.Run{withRunCancelled(newRun(runs[0]))},
}}
