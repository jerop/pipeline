...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.MatrixPermutation":                 schema_pkg_apis_pipeline_v1beta1_MatrixPermutation(ref),
		"github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.MatrixPermutations":                schema_pkg_apis_pipeline_v1beta1_MatrixPermutations(ref),
...
func schema_pkg_apis_pipeline_v1beta1_MatrixPermutation(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"permutationId": {
						SchemaProps: spec.SchemaProps{
							Description: "Identification of a permutation from the Parameters in a Matrix",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"params": {
						SchemaProps: spec.SchemaProps{
							Description: "A specific permutation of Parameters in a Matrix",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_pipeline_v1beta1_MatrixPermutations(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"pipelineTaskPermutations": {
						SchemaProps: spec.SchemaProps{
							Type: []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.MatrixPermutation"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.MatrixPermutation"},
	}
}
					...
					"matricesPermutations": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.MatrixPermutations"),
									},
								},
							},
						},
