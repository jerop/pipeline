...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatrixPermutation) DeepCopyInto(out *MatrixPermutation) {
	*out = *in
	if in.Params != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatrixPermutation.
func (in *MatrixPermutation) DeepCopy() *MatrixPermutation {
	if in == nil {
		return nil
	}
	out := new(MatrixPermutation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatrixPermutations) DeepCopyInto(out *MatrixPermutations) {
	*out = *in
	if in.Permutations != nil {
		in, out := &in.Permutations, &out.Permutations
		*out = make([]*MatrixPermutation, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MatrixPermutation)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatrixPermutations.
func (in *MatrixPermutations) DeepCopy() *MatrixPermutations {
	if in == nil {
		return nil
	}
	out := new(MatrixPermutations)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PipelineRunStatusFields) DeepCopyInto(out *PipelineRunStatusFields) {
	*out = *in
	...
	if in.MatricesPermutations != nil {
		in, out := &in.MatricesPermutations, &out.MatricesPermutations
		*out = make([]*MatrixPermutations, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MatrixPermutations)
