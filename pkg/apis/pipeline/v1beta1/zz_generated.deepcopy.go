...
func (in *PipelineTask) DeepCopyInto(out *PipelineTask) {
	*out = *in
	...
	if in.When != nil {
		...
		*out = new(UnscopedOrScopedWhenExpressions)
		(*in).DeepCopyInto(*out)
	}
	if in.RunAfter != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScopedWhenExpressions) DeepCopyInto(out *ScopedWhenExpressions) {
	*out = *in
	if in.WhenExpressions != nil {
		in, out := &in.WhenExpressions, &out.WhenExpressions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScopedWhenExpressions.
func (in *ScopedWhenExpressions) DeepCopy() *ScopedWhenExpressions {
	if in == nil {
		return nil
	}
	out := new(ScopedWhenExpressions)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UnscopedOrScopedWhenExpressions) DeepCopyInto(out *UnscopedOrScopedWhenExpressions) {
	*out = *in
	if in.WhenExpressions != nil {
		in, out := &in.WhenExpressions, &out.WhenExpressions
		*out = make(WhenExpressions, len(*in))
	...
	in.ScopedWhenExpressions.DeepCopyInto(&out.ScopedWhenExpressions)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnscopedOrScopedWhenExpressions.
func (in *UnscopedOrScopedWhenExpressions) DeepCopy() *UnscopedOrScopedWhenExpressions {
	if in == nil {
		return nil
	}
	out := new(UnscopedOrScopedWhenExpressions)
